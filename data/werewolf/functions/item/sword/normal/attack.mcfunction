##クールタイム設定
#剣を持ち替え
item modify entity @s weapon.mainhand werewolf:set_custom_data/sword/normal_sword_cooltime
#クールタイムを設定
...
damage @e[tag=target,sort=nearest,limit=1] 4 werewolf:dummy_skill
tag @e[tag=this,sort=nearest,limit=1] remove target


advancement revoke @s only werewolf:player_hurt_entity/item/nomal_sword