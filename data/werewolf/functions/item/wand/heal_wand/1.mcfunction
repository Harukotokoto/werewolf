...
## 演出
particle minecraft:dust{color:[1.0,0.4,1.0],scale:1.8} ~ ~ ~ 0 0 0 0 2 force @a


## 物理演算
function werewolf:item/wand/heal_wand/3
## ダメージ処理
...
execute as @e[tag=hit_magic_bullet] at @s run function werewolf:item/wand/heal_wand/damage