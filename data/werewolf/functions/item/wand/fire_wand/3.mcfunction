...
execute as @s[tag=motion_x] at @s if data storage item: {motion:0d} run function werewolf:item/wand/fire_wand/damage
...
execute as @s[tag=motion_y] at @s if data storage item: {motion:0d} run function werewolf:item/wand/fire_wand/damage
...
execute as @s[tag=motion_z] at @s if data storage item: {motion:0d} run function werewolf:item/wand/fire_wand/damage
