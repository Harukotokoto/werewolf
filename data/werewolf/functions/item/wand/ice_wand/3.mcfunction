...
execute as @s[tag=motion_x] at @s if data storage item: {motion:0d} run particle minecraft:dust{color:[0.0,0.0,0.0],scale:1.8} ~ ~ ~ 0.3 0.3 0.3 0 5 force @a
...
execute as @s[tag=motion_y] at @s if data storage item: {motion:0d} run particle minecraft:dust{color:[0.0,0.0,0.0],scale:1.8} ~ ~ ~ 0.3 0.3 0.3 0 5 force @a
...
execute as @s[tag=motion_z] at @s if data storage item: {motion:0d} run particle minecraft:dust{color:[0.0,0.0,0.0],scale:1.8} ~ ~ ~ 0.3 0.3 0.3 0 5 force @a
