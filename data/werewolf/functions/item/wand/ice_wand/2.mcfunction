...
#アイテム用意
execute anchored eyes run summon item ^ ^-0.1 ^0.5 {Item:{id:"minecraft:carrot_on_a_stick",components:{"minecraft:ice_resistant":{},"minecraft:custom_model_data":99999}},Health:1s,PickupDelay:10000,Tags:["magic_bullet","ice","not_yet"],NoGravity:true,Age:5950}
#投擲者を記録
...
#ベクトル計算(max:1.6)
summon area_effect_cloud ^ ^ ^1.4 {Tags:["magic_bullet_motion"]}
#x(reserve_1)
