...
## 演出
particle minecraft:dust{color:[0.0,1.0,1.0],scale:1.8} ~ ~ ~ 0 0 0 0 2 force @a


## 物理演算
function werewolf:item/wand/ice_wand/3
## ダメージ処理
...
execute as @e[tag=hit_magic_bullet] at @s run function werewolf:item/wand/ice_wand/damage