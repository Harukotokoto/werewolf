...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"インベントリシャッフル"}'
...
tellraw @a {"text":"[システム] クエスト発生: インベントリシャッフル"}
tellraw @a {"text":"[システム] 皆の所持品が入れ替わる…"}
...
## クエスト実行
function werewolf:quest/inventory_exchange/