...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"色が異なる水の妖精"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"目標: 青いウーパールーパーの保護"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"報酬: 最大体力の増加"}'
...
tellraw @a {"text":"[システム] クエスト発生: 色が異なる水の妖精"}
tellraw @a {"text":"[システム] 青色のウーパールーパーを保護せよ"}
...
## クエスト実行
function werewolf:quest/poison_axolotl/summon with storage werewolf: settings
function werewolf:quest/poison_axolotl/