...
#ここに制限時間
scoreboard players set #GameManager reserve_0 1200
...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"うちの狼を知りませんか？"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"目標: 狼を飼い主に送り届ける"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"報酬: エメラルドx7"}'
...
tellraw @a {"text":"[システム] クエスト発生: うちの狼を知りませんか？"}
tellraw @a {"text":"[システム] 狼は飼い主とはぐれてしまったようだ…"}
...
## クエスト実行
function werewolf:quest/where_is_my_wolf/summon with storage werewolf: settings
function werewolf:quest/where_is_my_wolf/