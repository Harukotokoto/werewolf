...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"食料不足"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"目標: パン10個の納品"}'
...
tellraw @a {"text":"[システム] クエスト発生: 食料不足"}
tellraw @a {"text":"[システム] 納品BOXにパンを10個納品しろ"}
...
## クエスト実行
function werewolf:quest/delivery_bread/summon with storage werewolf: settings
function werewolf:quest/delivery_bread/