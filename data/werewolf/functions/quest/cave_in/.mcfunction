...
## イベント終了処理
execute if score #GameManager quest_timer matches 0 run return run function werewolf:quest/cave_in/0

## 再帰処理
execute if data storage werewolf: gamestate.quest{active:true} run schedule function werewolf:quest/cave_in/ 1t