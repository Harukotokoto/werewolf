...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"飛来する鮭"}'
...
tellraw @a {"text":"[システム] クエスト発生: 飛来する鮭"}
tellraw @a {"text":"[システム] 多数の鮭が空から降ってくる…"}
...
## クエスト実行
function werewolf:quest/falling_salmon/summon with storage werewolf: settings
function werewolf:quest/falling_salmon/