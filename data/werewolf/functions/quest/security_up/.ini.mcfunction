...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"霊界の警報"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"目標: エメラルド20個の納品"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"報酬: 次回死亡時にアナウンス"}'
...
tellraw @a {"text":"[システム] クエスト発生: 霊界の警報"}
tellraw @a {"text":"[システム] 納品BOXにエメラルドを20個納品しろ"}
...
##納品数設定
data modify storage werewolf: gamestate.quest.count set value 20

## クエスト実行
function werewolf:quest/security_up/summon with storage werewolf: settings
function werewolf:quest/security_up/