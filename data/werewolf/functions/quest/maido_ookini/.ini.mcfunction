...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"まいどおおきに"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"目標:  -"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"報酬:  氷の剣のショップ取り扱い"}'
...
tellraw @a {"text":"[システム] クエスト発生: まいどおおきに"}
tellraw @a {"text":"[システム] ショップに新商品が並んだようだ"}
...
## クエスト実行
function werewolf:quest/maido_ookini/