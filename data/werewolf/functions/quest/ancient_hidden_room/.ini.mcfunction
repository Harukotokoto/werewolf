...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"古代の潜窟"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"目標: 2人で隠された部屋を開ける"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"報酬: 石板の解放/氷の剣"}'
...
tellraw @a {"text":"[システム] クエスト発生: 古代の潜窟"}
tellraw @a {"text":"[システム] どこからか不思議な力を感じる…"}
...
## クエスト実行
function werewolf:quest/ancient_hidden_room/summon with storage werewolf: settings
function werewolf:quest/ancient_hidden_room/