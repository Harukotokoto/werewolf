...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"酸性雨"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"目標: 一定時間雨を耐え凌ぐ"}'
...
tellraw @a {"text":"[システム] クエスト発生: 酸性雨"}
tellraw @a {"text":"[システム] 大気が不安定だ… すぐに雨が降るだろう"}
...
## クエスト実行
function werewolf:quest/acid_rain/