...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"赤い果実の収穫期"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"目標: リンゴ10個の納品"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"報酬:  -"}'
data modify storage werewolf: gamestate.quest.text append value '{"text":"失敗: 空腹(村/第三陣営)"}'
#bar
data modify storage werewolf: gamestate.quest.text append value '{"text":"\\uF812\\uF000\\uF813"}'
...
tellraw @a {"text":"[システム] クエスト発生: 赤い果実の収穫期"}
tellraw @a {"text":"[システム] 納品BOXにリンゴを10個納品しろ"}
...
## クエスト実行
function werewolf:quest/delivery_apple/summon with storage werewolf: settings
function werewolf:quest/delivery_apple/