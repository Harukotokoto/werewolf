...
#内容
data modify storage werewolf: gamestate.quest.text append value '{"text":"集団テレポート"}'
...
tellraw @a {"text":"[システム] クエスト発生: 集団テレポート"}
tellraw @a {"text":"[システム] 皆の場所がランダムで入れ替わる…"}
...
## クエスト実行
function werewolf:quest/random_teleport/