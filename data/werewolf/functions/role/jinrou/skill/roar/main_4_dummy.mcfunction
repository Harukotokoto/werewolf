...
execute as @s[tag=motion_x] at @s if data storage item: {motion:0d} as @e[type=item,tag=roar_dummy] on origin run particle minecraft:explosion ~ ~1 ~ 1 1 1 0 3 force @s
...
execute as @s[tag=motion_y] at @s if data storage item: {motion:0d} as @e[type=item,tag=roar_dummy] on origin run particle minecraft:explosion ~ ~1 ~ 1 1 1 0 3 force @s
...
execute as @s[tag=motion_z] at @s if data storage item: {motion:0d} as @e[type=item,tag=roar_dummy] on origin run particle minecraft:explosion ~ ~1 ~ 1 1 1 0 3 force @s
