...
$data modify storage werewolf: role.$(result).camp set value "maniac"
# 最大人数を設定
...
##その他
# 罠の同時設置数
$execute unless data storage werewolf: role.$(result).skill_2.count run data modify storage werewolf: role.$(result).skill_2.count set value 4
#罠にかかった場合のscoreboard
