...
#return判定
execute unless entity @a[tag=team_ponkotsu] run return fail
...
'[{"interpret":true,"nbt":"role.ponkotsu.name","storage":"werewolf:","color":"#4e5c24"},{"text":"   "},{"selector":"@a[tag=team_ponkotsu]","color":"green","font":"default"}]'
