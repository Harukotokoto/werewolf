...
##抽選
tag @e[type=armor_stand,tag=ponkotsu_role,sort=random,limit=1] add dummy_role_as
...
kill @e[type=armor_stand,tag=ponkotsu_role]

##役職処理を実行
function werewolf:role/ponkotsu/skill/1 with storage macro:

##タグ付け
tag @s add this_ponkotsu