...
##その他
#騎士の守護用scoreboard
scoreboard objectives add protected_new dummy
scoreboard objectives add protected_old dummy
scoreboard objectives add protected_dummy_new dummy
scoreboard objectives add protected_dummy_old dummy
