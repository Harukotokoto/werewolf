##cooltime_remove
execute store result score #GameManager reserve_0 run data get storage werewolf: role.soujiya.skill_0.cooltime
...
execute store result storage werewolf: role.soujiya.skill_0.cooltime int 1 run scoreboard players get #GameManager reserve_0
