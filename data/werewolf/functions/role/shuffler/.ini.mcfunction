...
$data modify storage werewolf: role.$(result).camp set value "wolf"
# 最大人数を設定
...
#スキル2(時間回復)
# スキル2のデフォルトクールタイム
$execute unless data storage werewolf: role.$(result).skill_2.cooltime run data modify storage werewolf: role.$(result).skill_2.cooltime set value 2400
# スキル2の回数制限
