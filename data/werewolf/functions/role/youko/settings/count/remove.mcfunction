#第三陣営は1役職に制限
execute if data storage werewolf: role.youko{camp:"third"} if data storage werewolf: role.youko{count:0} run return fail
...
#第三陣営のロック解除
execute if data storage werewolf: role.youko{camp:"third"} if data storage werewolf: role.youko{count:0} run data modify storage macro: util.role_processing.third_camp set value 0
