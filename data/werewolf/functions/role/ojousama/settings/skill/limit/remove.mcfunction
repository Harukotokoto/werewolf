##limit_remove
execute store result score #GameManager reserve_0 run data get storage werewolf: role.ojousama.skill_0.limit
...
execute store result storage werewolf: role.ojousama.skill_0.limit int 1 run scoreboard players get #GameManager reserve_0
