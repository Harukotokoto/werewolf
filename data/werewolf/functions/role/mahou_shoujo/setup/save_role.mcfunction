...
#return判定
execute unless entity @a[tag=team_mahou_shoujo] run return fail
...
'[{"interpret":true,"nbt":"role.mahou_shoujo.name","storage":"werewolf:","color":"#4e5c24"},{"text":"   "},{"selector":"@a[tag=team_mahou_shoujo]","color":"green","font":"default"}]'
