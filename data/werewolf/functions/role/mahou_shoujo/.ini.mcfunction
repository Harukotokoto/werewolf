...
##その他
#ダミー役職で開始するかの設定
$execute unless data storage werewolf: role.$(result).first_dummy run data modify storage werewolf: role.$(result).first_dummy set value true
#role.mahou_shoujo.dummy_role_listに陣営を追加
#$data modify storage werewolf: role.$(result).dummy_role_list append value "uranai"
#data modify storage werewolf: role.$(result).dummy_role_list append value "soujiya"
#$data modify storage werewolf: role.$(result).dummy_role_list append value "saibankan"
