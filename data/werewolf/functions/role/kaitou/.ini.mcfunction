...
##その他
#語り設定
execute unless data storage werewolf: role.kaitou.talk run data modify storage werewolf: role.kaitou.talk set value true
#語りのスコアボード
scoreboard objectives add talk_kaitou minecraft.custom:play_time
