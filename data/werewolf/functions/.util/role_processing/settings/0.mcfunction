...
unless data storage werewolf: role.$(result){display_settings:false} run \
function werewolf:.util/role_processing/settings/1 with storage macro: util.role_processing
...
# 再帰処理
function werewolf:.util/role_processing/settings/0 with storage macro: util.role_processing