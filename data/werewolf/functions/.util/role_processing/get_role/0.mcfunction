...
execute if entity @s[team=$(reserve_0)] run return run data modify storage macro: reserve_0 set value "$(reserve_0)"
...
# 再帰処理
function werewolf:.util/role_processing/get_role/0 with storage macro: